...
public class ReviewController {
    ...
    public ResponseEntity<GlobalApiResponse<Page<ReviewResponse>>> getUserReview(@AuthenticationPrincipal User user, Pageable pageable) {
        Page<ReviewResponse> responses = reviewService.getUserReview(user.getId(), pageable);
